<b>Event-manager</b> - это приложение позволит менеджеру ивента: собрать данные о гостях, создать персональные встречи для них через Admin, а также просмотреть всю их историю.
